        ...
        <header className="border-b border-slate-200/70 bg-white/55 px-4 py-4 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/45 lg:px-7">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold tracking-tight">Data Analyst Workspace</h2>
                <p className="text-sm text-slate-600 dark:text-slate-400">Design-grade interface with fast SQL/Python generation</p>
              </div>
            </div>
        ...
        <section className="flex-1 overflow-auto px-4 pb-4 lg:px-7">
          {!response ? (
            <div className={`${panel} mx-auto mt-4 max-w-5xl p-8`}>
              <h3 className="text-center text-4xl font-semibold tracking-tight">How can I help with your data today?</h3>
